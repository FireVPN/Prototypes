...
def get_official_address(destination):
    sock.sendto("want Address".encode('utf-8'), destination)
...
addr_srv0 = get_official_address((srv0_ip,srv0_port))
print ("official Address from server0:", addr_srv0)

#zu Server1 verbinden und IP+Port erhalten
addr_srv1 = get_official_address((srv1_ip,srv1_port))
